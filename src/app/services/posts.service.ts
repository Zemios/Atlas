...
export class PostsService {
  ...
  getUserPosts(userId: number, page: number, limit: number): Observable<PostInterface[]> {
    return this.http.get<PostInterface[]>(API_URL + this.route + `user/${userId}?page=${page}&limit=${limit}`);
  }
